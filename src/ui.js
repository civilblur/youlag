...
function handleArticleSplitView() {
  ...
  function scrollToActiveArticle(element, container) {
    ...
    const offsetTop = topNavHeight + stickyHeaderHeight;
...
function setToolbarSticky(toolbarElement) {
  ...
  // Bind scroll listener to the right element based on mode
  const scrollTarget = (isArticleSplitViewEnabled() && isArticleSplitViewActive())
    ? getFeedRoot() || window
    : window;
