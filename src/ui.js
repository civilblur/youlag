...
function handleArticleSplitView() {
  ...
  function scrollToActiveArticle(element, container) {
    ...
    // ScrollTop includes extra offset to reveal the previous/next article, to easier navigate when using a mouse. 
    if (elementRect.top < containerRect.top) {
      container.scrollTop -= (containerRect.top - elementRect.top + 90);
    }
    else if (elementRect.bottom > containerRect.bottom) {
      container.scrollTop += (elementRect.bottom - containerRect.bottom + 60);
    }
  }
