...
function settingsPageEventListeners() {
  function formValidation() {
    ...
    const videoLabelCheckbox = document.getElementById(
    ...
    if (videoLabelCheckbox) {
      ...
      const videoLabelIsChecked = videoLabelCheckbox
...
function setAddFeedCategoryValue() {
  ...
  if (
    page &&
    pathname === `${app.frss.urlPrefix}/i/` &&
    page.url.includes("c=subscription") &&
    page.url.includes("a=add")
  ) {
