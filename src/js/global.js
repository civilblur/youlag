...
app.modal = {
  id: {
    ...
    share: "youlagShareManage",
    shareContainer: "youlagShareModal",
  ...
  class: {
    ...
    descParagraph3: "youlag-video-description-content__paragraph-3",
    ...
    shareModalRoot: "youlag-share-modal",
    shareModalItem: "yl-share-list-item",
    shareModalOpen: "youlag-share-modal-open",
